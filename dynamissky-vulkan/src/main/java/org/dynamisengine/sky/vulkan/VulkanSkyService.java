...
import org.dynamisengine.sky.api.descriptor.SkyModelType;
import org.dynamisengine.sky.api.gpu.SkyGpuResources;
import org.dynamisengine.sky.api.service.SkyService;
...
import org.dynamisengine.sky.vulkan.internal.gpu.NoopSkyGpuBackendAdapter;
import org.dynamisengine.sky.vulkan.internal.gpu.SkyGpuBackendAdapter;
import org.dynamisengine.sky.vulkan.lut.AerialPerspectiveLutUpdater;
import org.dynamisengine.sky.vulkan.lut.CameraState;
import org.dynamisengine.sky.vulkan.lut.GpuMemoryOps;
import org.dynamisengine.sky.vulkan.lut.MultiScatteringLutBaker;
import org.dynamisengine.sky.vulkan.lut.SkyLutCache;
import org.dynamisengine.sky.vulkan.lut.SkyLutResources;
import org.dynamisengine.sky.vulkan.lut.SkyViewLutUpdater;
import org.dynamisengine.sky.vulkan.lut.TransmittanceLutBaker;
import org.dynamisengine.sky.vulkan.pass.HdriSkyPass;
import org.dynamisengine.sky.vulkan.pass.SkyBackgroundPass;
import org.dynamisengine.sky.vulkan.pass.SkyPassSelector;
import org.dynamisengine.sky.vulkan.pass.SkyPassUbo;
...
public final class VulkanSkyService implements SkyService {
    ...
    static VulkanSkyService create(long device, GpuMemoryOps memoryOps, SkyConfig config, SkyGpuBackendAdapter gpuBackendAdapter) {
        ...
        var descriptorSets = org.dynamisengine.sky.vulkan.descriptor.SkyDescriptorSets.create(luts);
    ...
    public void update(SkyFrameContext ctx) {
        ...
        SolarPosition solar = SolarPositionCalculator.compute(
                ...
                latLon,
                new org.dynamisengine.sky.core.solar.TimeZoneOffset((float) 0));
